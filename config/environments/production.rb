Ffstrike::Application.configure do
  ...
  config.action_mailer.default_url_options = { :host => "http://www.congoevents.org", :locale => I18n.locale }
  ...
  config.action_controller.asset_host = "d1fev4ysucizmd.cloudfront.net"
