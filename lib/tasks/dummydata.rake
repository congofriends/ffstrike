namespace :db do
  ...
  task make_fotc: :environment do
    ...
    movement = coordinator.movements.where(name: "Friends of the Congo").first_or_create!(
        ...
        published: true,
        video: "https://www.youtube.com/watch?v=vLV9szEu9Ag",
  ...
  fotc_event1 = movement.events.create!(
        host_id: coordinator.id,
   ...
   fotc_event2 = movement.events.create!(
        host_id: coordinator.id,
   ...
   fotc_event3 = movement.events.create!(
        host_id: coordinator.id,
    ...
    sub_movement1 = coordinator.movements.where(name: "Break the Silence").first_or_create!(
    ...
    sub_movement2 = submovement_owner.movements.where(name: "Conflict Minerals Petition Day").first_or_create!(
        ...
        published: true,
        parent_id: movement.id,
        video: "https://www.youtube.com/watch?v=89rKdJjumdA",
