class RoleApplication 
  ...
  validates_presence_of :why_cause, :other, :message => "It is important for your team coordinator to know why you are interested... Please fill in the questions below."
end
